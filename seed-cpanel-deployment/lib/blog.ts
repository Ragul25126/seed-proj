...
“Seed’s core principle is to integrate sustainability and energy-efficient design in its products and services from the concept stage itself.” SEED offers a curated set of comprehensive MEP which generally includes Plumbing, Fire Fighting, Fire Protection, Electrical, HVAC, Networking (Telecom / Data / Structural Cabling / ELV), BMS, CCTV and Lighting design. The company prominently designs exclusive products for Vertical Transportation, Gas Bank, Irrigation, Solar works, Bio digester, STP, WTP / RO etc.
