        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <Reveal delay={0.15}>
            <ProjectGallery
              ...
              objectFit="cover"
              containImages={['/projects/mandarin-wasl-tower.webp', '/projects/mandarin-wasl-2-new.jpg', '/projects/ellington-hq.png', '/projects/namaste-tower-view-1.png', '/projects/namaste-tower-view-2.png']}
                ...
                {images.map((img: string, idx: number) => (
                  <div key={idx} className="relative aspect-[16/10] bg-[#0a1020] rounded-sm overflow-hidden border border-white/10 group shadow-xl">
                    <Image
                      ...
                      fill
                      unoptimized
                      className={`${(proj.slug === 'saas-st-regis' || img === '/projects/namaste-tower-view-1.png' || img === '/projects/namaste-tower-view-2.png' || img === '/projects/mandarin-wasl-2-new.jpg' || img === '/projects/ellington-hq.png' || img.includes('uptown-mercer-house')) ? 'object-contain' : 'object-cover'} group-hover:scale-105 transition-transform duration-700`}
